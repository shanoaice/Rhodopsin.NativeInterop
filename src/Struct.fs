namespace Rhodopsin.NativeInterop.Struct
...
type FFIVector(vecBuffer: nativeint, vecLength: unativeint, vecCapacity: unativeint) =
    ...
    member this.FromVecVecUTF16Char() =
        let rawPtr = NativeInterop.NativePtr.ofNativeInt<FFIVector> this.buffer
        let length = this.len
