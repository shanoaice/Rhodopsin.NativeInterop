...
open Rhodopsin.NativeInterop.String
...
type Vector(vecBuffer: nativeint, vecLength: unativeint, vecCapacity: unativeint) =
    ...
    /// <summary>
    /// Represents the underlying <c>Vec&lt;T&gt;</c> data as a <c>System.Span&lt;T&gt;</c>, including empty spaces at the end.<br/>
    /// Due to CLR limit, you will not be able to access any element beyond <c>Int32.MaxValue</c>.
    /// </summary>
    ...
    /// <summary>
    /// Marshals strings inside the vector as C-style NUL terminated strings. When operating on a large amount of data, this might become a performance bottleneck. Consider converting the string into a vector of UTF-16 beforehand and use <see cref="M:Rhodopsin.NativeInterop.Vector.FromVecUTF16Char"/> instead.
    /// </summary>
    ...
    /// <summary>
    /// Marshals strings inside the vector as Rust-style UTF-8 encoded strings. <b>This method preserves embedded NUL character.</b> When operating on a large amount of data, this might become a performance bottleneck. Consider converting the string into a vector of UTF-16 beforehand and use <see cref="M:Rhodopsin.NativeInterop.Vector.FromVecUTF16Char"/> instead.
    /// </summary>
    /// <returns>An <c>IEnumerable&lt;String&gt;</c> representing all the strings in the vector in original order.</returns>
